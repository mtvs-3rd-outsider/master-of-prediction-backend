...
public class UserSearchDTO {
    ...
    public UserSearchDTO(Long id, String email, String userName, int age, Gender gender, Location location, Authority authority,LocalDate birthday, String avatarUrl ,String displayName) {
        this.id = id;
        this.email = email;
