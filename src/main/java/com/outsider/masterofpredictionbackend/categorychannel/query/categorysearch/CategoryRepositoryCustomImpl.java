...
public class CategoryRepositoryCustomImpl implements CategoryRepositoryCustom {
    ...
    @Override
    public Page<CategorySearchModel> findByDisplayNameOrContaining(String displayName, Pageable pageable) {
        ...
        // 검색 실행
        SearchHits<CategorySearchModel> searchHits = elasticsearchOperations.search(query, CategorySearchModel.class);
