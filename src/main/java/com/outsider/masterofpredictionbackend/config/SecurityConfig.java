    ...
    public SecurityFilterChain configure(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/v1/auth/login","/api/v1/auth/register","/api/v1/auth/signup/email","/api/v1/auth/signup/emailAuth","/api/v1/auth/forgot-password","/api/v1/auth/reset-password").permitAll()
