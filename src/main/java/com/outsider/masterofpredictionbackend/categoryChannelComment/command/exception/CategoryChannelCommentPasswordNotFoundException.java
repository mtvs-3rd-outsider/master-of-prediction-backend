...
@Getter
public class CategoryChannelCommentPasswordNotFoundException extends RootException {
     ...
     */
    public CategoryChannelCommentPasswordNotFoundException(String logMessage, String clientMessage) {
